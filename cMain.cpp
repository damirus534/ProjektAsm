...
cMain::cMain() : wxFrame(nullptr, wxID_ANY, "ProjektAsm", wxPoint(560, 240),wxSize(800,600)) {
	...
	//przyciski
	inputFileButton = new wxButton(this, wxID_ANY, "Wgraj plik", wxPoint(10, 10), wxSize(120, 30));
	openOutputFileButton = new wxButton(this, wxID_ANY, "Otworz plik", wxPoint(340, 10), wxSize(120, 30));
	run = new wxButton(this, wxID_ANY, "Uruchom", wxPoint(630, 500), wxSize(120, 30));

	//checkboxy
	cppCheckBox = new wxCheckBox(this, wxID_ANY, "c++", wxPoint(10, 120), wxSize(60, 15));
	asmCheckBox = new wxCheckBox(this, wxID_ANY, "asm", wxPoint(10, 140), wxSize(60, 15));
...
void cMain::onSliderChange(wxCommandEvent& evt) {
